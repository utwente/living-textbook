...
Encore
    ...
    .copyFiles([
      {from: './node_modules/ckeditor4-nonlts/', to: 'ckeditor/[path][name].[ext]', pattern: /\.(js|css)$/, includeSubdirectories: false},
      {from: './node_modules/ckeditor4-nonlts/adapters', to: 'ckeditor/adapters/[path][name].[ext]'},
      {from: './node_modules/ckeditor4-nonlts/lang', to: 'ckeditor/lang/[path][name].[ext]'},
      {from: './node_modules/ckeditor4-nonlts/plugins', to: 'ckeditor/plugins/[path][name].[ext]'},
      {from: './node_modules/ckeditor4-nonlts/skins', to: 'ckeditor/skins/[path][name].[ext]'},
      {from: './node_modules/ckeditor4-nonlts/vendor', to: 'ckeditor/vendor/[path][name].[ext]'}
    ])
