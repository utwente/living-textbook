...
Encore
  ...
  .addEntry("app", ["./assets/js/app.js", "./assets/js/_fos_js_routes.js"])
  .addEntry("double-column", "./assets/js/doubleColumn.js")
  .addEntry("content", [
    "./assets/js/content.js",
    "symfony-collection/jquery.collection.js",
  ])
  .addEntry("analytics", ["./assets/js/analytics/main.js"])
  .addEntry("ckeditorPatches", ["./assets/js/ckeditorPatches.js"])
  .addEntry("ckeditorContents", ["./assets/css/ckeditor/ckeditor.scss"])
  ...
  .copyFiles([
    ...
    {
      from: "./vendor/studio-42/elfinder/css",
      to: "els/css/[path][name].[ext]",
    },
    {
      from: "./vendor/studio-42/elfinder/img",
      to: "els/img/[path][name].[ext]",
    },
    { from: "./vendor/studio-42/elfinder/js", to: "els/js/[path][name].[ext]" },
    {
      from: "./vendor/studio-42/elfinder/sounds",
      to: "els/sounds/[path][name].[ext]",
    },
    {
