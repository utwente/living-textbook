...
class StylingConfigurationConceptOverrideController extends AbstractApiController
{
  ...
  #[OA\RequestBody(description: 'The new override', required: true, content: [
    new OA\JsonContent(ref: new Model(type: StylingConfigurationConceptOverrideApiModel::class, groups: ['create'])),
  ])]
  ...
  #[OA\RequestBody(description: 'The concept styling override to update', required: true, content: [
    new OA\JsonContent(ref: new Model(type: StylingConfigurationConceptOverrideApiModel::class, groups: ['mutate'])),
  ])]
