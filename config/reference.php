 ...
 *             default_timezone?: scalar|Param|null, // Default: "Europe/Amsterdam"
 ...
 *     },
 * }
 * @psalm-type DrensoSharedConfig = array{
 *     public_services?: bool|Param, // Default: false
 *     api?: array{
 *         convert_entity_validation_exception?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             controller_prefix?: list<scalar|Param|null>,
 *             data_field?: scalar|Param|null, // Default: "payload"
 *         },
 *     },
 *     commands?: array{
 *         check_action_security?: bool|array{
 *             enabled?: bool|Param, // Default: true
 *             excluded_controllers?: list<scalar|Param|null>,
 *         },
 *         check_messenger_monitor?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             failed_queue?: scalar|Param|null, // The failed queue name // Default: "failed"
 *             disabled_queues?: list<scalar|Param|null>,
 *             now_margin?: int|Param, // The amount of minutes around now // Default: 5
 *         },
 *     },
 *     database?: array{
 *         softdeletable?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             use_gedmo_workaround?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *                 use_utc?: bool|Param, // Default: true
 *             },
 *             disable_post_flush_detach?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *             },
 *         },
 *     },
 ...
 *             translate_sender_name?: bool|Param, // Default: true
 *         },
 *     },
 *     env?: array{
 *         processors?: array{
 *             false_or_string?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *             },
 *             phpstorm?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 ...
 *     messenger?: array{
 *         middleware?: array{
 *             doctrine_transaction?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *             },
 *         },
 *     },
 *     sentry_tunnel?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         allowed_dsn?: list<scalar|Param|null>,
 *         connect_timeout?: int|Param, // Default: 2
 *         max_duration?: int|Param, // Default: 4
 *     },
 *     serializer?: array{
 *         handlers?: array{
 *             decimal?: bool|array{
 ...
 *             enum?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *                 supported_enums?: list<scalar|Param|null>,
 *             },
 *             id_map?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *             },
 *         },
 *         static_serializer?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *         },
 *         twig_integration?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *         },
 *         deserialization?: array{
 *             direct_constructor?: bool|array{
 *                 enabled?: bool|Param, // Default: false
 *             },
 *         },
 *     },
 *     services?: array{
 *         feature_flags?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             configuration_file?: scalar|Param|null, // Default: null
 *             configuration_local_file?: scalar|Param|null, // Default: null
 *             json_comment_parser_enabled?: bool|Param, // Default: true
 *             custom_handler?: scalar|Param|null, // Default: null
 *         },
 *         gravatar?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             fallback_style?: scalar|Param|null, // Default: "mp"
 *             twig_integration?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *             },
 *         },
 *         phone_number?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *             national_country_code?: scalar|Param|null,
 *             twig_integration?: bool|array{
 *                 enabled?: bool|Param, // Default: true
 *             },
 *         },
 *         spreadsheethelper?: bool|array{
 *             enabled?: bool|Param, // Default: false
 *         },
 *         datetimeprovider?: bool|array{
 *             enabled?: bool|Param, // Default: true
 *             clock_interface?: bool|Param, // Default: false
 *         },
 *     },
 * }
 ...
 *     bobv_latex?: BobvLatexConfig,
 *     fos_ck_editor?: FosCkEditorConfig,
 *     webpack_encore?: WebpackEncoreConfig,
 *     sentry?: SentryConfig,
 *     twig_extra?: TwigExtraConfig,
 *     nelmio_api_doc?: NelmioApiDocConfig,
 *     drenso_shared?: DrensoSharedConfig,
