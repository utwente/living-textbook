...
final class Version20230628143927 extends AbstractMigration
{
    ...
    {
        return 'adding additional resources to concept';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE concept ADD additional_resources_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE concept DROP additional_resources_id');
    }
